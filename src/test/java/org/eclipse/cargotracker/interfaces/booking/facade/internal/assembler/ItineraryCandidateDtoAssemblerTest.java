...
public class ItineraryCandidateDtoAssemblerTest {
    ...
    public void testFromDto() {
        ...
        legs.add(new org.eclipse.cargotracker.interfaces.booking.facade.dto.Leg("CM001", "AAAAA", "A","BBBBB", "B", LocalDateTime.now(), LocalDateTime.now()));
        legs.add(new org.eclipse.cargotracker.interfaces.booking.facade.dto.Leg("CM001", "BBBBB", "B","CCCCC","C", LocalDateTime.now(), LocalDateTime.now()));
        ...
        // Tested call
        final Itinerary itinerary = assembler.fromDTO(new RouteCandidate(legs), voyageRepository, locationRepository);
