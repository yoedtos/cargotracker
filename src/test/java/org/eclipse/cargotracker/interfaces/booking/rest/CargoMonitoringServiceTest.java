...
public class CargoMonitoringServiceTest {
    ...
    public void testGetAllPosts() throws Exception {
        ...
        final WebTarget getAllPostsTarget = client.target(new URL(base, "rest/cargo").toExternalForm());

        // Response is an autocloseable resource.
        try (final Response getAllPostsResponse = getAllPostsTarget.request()
