...
public class HandlingEventTest {
	...
	public void testNewWithCarrierMovement() {
		HandlingEvent event1 = new HandlingEvent(cargo, LocalDateTime.now(), LocalDateTime.now(), HandlingEvent.Type.LOAD,
				SampleLocations.HONGKONG, SampleVoyages.CM003);
		assertEquals(SampleLocations.HONGKONG, event1.getLocation());

		HandlingEvent event2 = new HandlingEvent(cargo, LocalDateTime.now(), LocalDateTime.now(), HandlingEvent.Type.UNLOAD,
		...
		for (HandlingEvent.Type type : Arrays.asList(HandlingEvent.Type.CLAIM, HandlingEvent.Type.RECEIVE,
			...
			try {
				new HandlingEvent(cargo, LocalDateTime.now(), LocalDateTime.now(), type, SampleLocations.HONGKONG, SampleVoyages.CM003);
		...
		for (HandlingEvent.Type type : Arrays.asList(HandlingEvent.Type.LOAD, HandlingEvent.Type.UNLOAD)) {
			try {
				new HandlingEvent(cargo, LocalDateTime.now(), LocalDateTime.now(), type, SampleLocations.HONGKONG, null);
	...
	public void testNewWithLocation() {
		HandlingEvent event1 = new HandlingEvent(cargo, LocalDateTime.now(), LocalDateTime.now(), HandlingEvent.Type.CLAIM,
	...
	public void testCurrentLocationLoadEvent() throws Exception {
		HandlingEvent event = new HandlingEvent(cargo, LocalDateTime.now(), LocalDateTime.now(), HandlingEvent.Type.LOAD,
	...
	public void testCurrentLocationClaimedEvent() throws Exception {
		HandlingEvent event = new HandlingEvent(cargo, LocalDateTime.now(), LocalDateTime.now(), HandlingEvent.Type.CLAIM,
				SampleLocations.CHICAGO);
