...
public class Leg implements Serializable {
  ...
  public Leg(
    ...
    // Hibernate issue:
    // when the `LocalDateTime` field is persisted into db, and retrieved from db, the values are
  ...
  private boolean sameValueAs(Leg other) {
    LOGGER.log(
        Level.INFO, "this.loadTime == other.loadTime:{0}", this.loadTime.equals(other.loadTime));
    LOGGER.log(
        Level.INFO,
