    ...
    for (org.eclipse.cargotracker.interfaces.booking.facade.dto.Leg legDTO :
      ...
      legs.add(
          new Leg(
              ...
              from,
              to,
              ZonedDateTime.parse(legDTO.getLoadTime(), DateTimeFormatter.ofPattern(DT_PATTERN))
                  .toLocalDateTime(),
              ZonedDateTime.parse(legDTO.getUnloadTime(), DateTimeFormatter.ofPattern(DT_PATTERN))
                  .toLocalDateTime()));
    }
