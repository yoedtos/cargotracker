...
public class LocationDtoAssembler {
    ...
    public List<org.eclipse.cargotracker.interfaces.booking.facade.dto.Location> toDtoList(
        ...
        List<org.eclipse.cargotracker.interfaces.booking.facade.dto.Location> dtoList = allLocations.stream()
                .map(this::toDto)
                .sorted(Comparator.comparing(org.eclipse.cargotracker.interfaces.booking.facade.dto.Location::getName))
